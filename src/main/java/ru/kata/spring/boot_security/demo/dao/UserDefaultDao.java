...
public class UserDefaultDao {
    ...
    public void setDefaultUser() {
        ...
        //создаем admin
        User userAdmin = new User("admin", userServiceImp.getPasswordHash("admin"), "email@google.com", setRoleAdmin);
        ...
        //создаем user
        User userUser = new User("user", userServiceImp.getPasswordHash("user"), "email@google.com", setRoleUser);
